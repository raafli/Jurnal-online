<div class="sidebar-wrapper">
    <div>
      <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="{{ asset('template/admin/zeta/assets/images/logo/small-logo.png') }}" alt=""><img class="img-fluid for-dark" src="{{ asset('template/admin/zeta/assets/images/logo/small-white-logo.png') }}" alt=""></a>
        <div class="back-btn"><i class="fa fa-angle-left"></i></div>
      </div>
      <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid" src="{{ asset('template/admin/zeta/assets/images/logo-icon.png') }}" alt=""></a></div>
      <nav class="sidebar-main">
        ...
        <div id="sidebar-menu">
          ...
          <div class="sidebar-img-section">
            <div class="sidebar-img-content"><img class="img-fluid" src="{{ asset('template/admin/zeta/assets/images/side-bar.png')}}"
            ') }}" alt="">
